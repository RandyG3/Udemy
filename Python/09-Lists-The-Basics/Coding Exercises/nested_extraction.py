...
def nested_extraction(lists, index_pos):
    return lists[index_pos][index_pos]


print(nested_extraction([[3, 4, 5], [7, 8, 9], [10, 11, 12]], 0))
print(nested_extraction([[3, 4, 5], [7, 8, 9], [10, 11, 12]], 1))
print(nested_extraction([[3, 4, 5], [7, 8, 9], [10, 11, 12]], 2))
